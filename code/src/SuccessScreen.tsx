  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── CHECKMARK — draws on via stroke-dashoffset transition ──
             Path: M52 74 L68 92 L112 50
             Approximate path length ≈ 86px → dasharray = 86              ── */}
        <path
          ...
          style={{
            ...
            transition: checkDrawn
              ? "stroke-dashoffset 0.62s cubic-bezier(0.25,1,0.5,1)"
              : "none",
          }}
        />
      </svg>
      ...
      <div style={{
        ...
        opacity: labelIn ? 1 : 0,
        transform: labelIn ? "translateY(0)" : "translateY(10px)",
