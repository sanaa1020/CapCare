...
interface Props { onNavigate: (dest: HubDest) => void; }
    ...
    >
          ...
          >
            ...
            <div style={{
              ...
              <div style={{
                ...
                fontWeight: 700, fontSize: "2.2rem", lineHeight: 1.12,
                color: "#f8f4ec",
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: "2.0rem", lineHeight: 1, color: "#f8f4f0",
          textShadow: "0 2px 14px rgba(0,0,0,0.64)",
        }}>
          CapCare<sup style={{ fontSize: "0.88rem", verticalAlign: "super" }}>+</sup>
        </div>
        <div style={{
          fontFamily: "Outfit, Helvetica, sans-serif",
          fontSize: "0.95rem", fontWeight: 300,
          color: "rgba(218,205,188,0.70)",
